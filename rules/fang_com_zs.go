...
var fangComZs = &spider.Spider{
	Name:        "房天下-中山",
	Description: "https://zs.newhouse.fang.com/house/s/b91/?ctm=1.zs.xf_search.page.2",
				...
				AidFunc: func(ctx *spider.Context, aid map[string]interface{}) interface{} {
					for loop := aid["loop"].([2]int); loop[0] <= loop[1]; loop[0]++ {
						ctx.AddQueue(&request.Request{
							Url:  fmt.Sprintf("https://zs.newhouse.fang.com/house/s/b%d/?ctm=1.zs.xf_search.page.%d", 90+loop[0], loop[0]),
